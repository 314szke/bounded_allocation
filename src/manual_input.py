...
def Input_2():
    config = ProblemConfiguration(3, 4, 10, 100, 1, 3, 10, 80, 3111)
    new_input = ProblemInput(config)
    ...
    new_input.buyers.append(Buyer(2, 10))
    new_input.buyers[2].wanted_item_ids = [1, 3]
    new_input.buyers[2].potential_expense = 90

    new_input.items.append(Item(0, 20, [1]))
    new_input.items.append(Item(1, 80, [0, 1, 2]))
    new_input.items.append(Item(2, 10, [0]))
    new_input.items.append(Item(3, 10, [2]))
    return new_input

def Input_3():
    config = ProblemConfiguration(5, 5, 100, 100, 1, 5, 100, 100, 5141)
    new_input = ProblemInput(config)
    ...
    new_input.buyers.append(Buyer(2, 100))
    new_input.buyers[2].wanted_item_ids = [0, 1, 2]
    new_input.buyers[2].potential_expense = 300

    new_input.buyers.append(Buyer(3, 100))
    new_input.buyers[3].wanted_item_ids = [0, 1, 2, 3]
    new_input.buyers[3].potential_expense = 400

    new_input.buyers.append(Buyer(4, 100))
    new_input.buyers[4].wanted_item_ids = [0, 1, 2, 3, 4]
    new_input.buyers[4].potential_expense = 500

    new_input.items.append(Item(0, 100, [0, 1, 2, 3, 4]))
    new_input.items.append(Item(1, 100, [1, 2, 3, 4]))
    new_input.items.append(Item(2, 100, [2, 3, 4]))
    new_input.items.append(Item(3, 100, [3, 4]))
    new_input.items.append(Item(4, 100, [4]))
